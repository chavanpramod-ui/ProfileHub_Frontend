  ...
  return (
    <div className="fixed inset-0 bg-slate-950/90 backdrop-blur-md flex items-center justify-center z-250 p-4 animate-in fade-in duration-300">
      ...
      <div className="bg-slate-900/80 border border-white/10 w-full max-w-lg rounded-[3rem] p-10 relative shadow-[0_20px_50px_rgba(0,0,0,0.5)]">
        ...
        <button 
          onClick={onClose} 
          className="absolute top-8 right-8 text-slate-muted hover:text-white transition-colors p-2 bg-cool-gray/5 rounded-full"
        >
          <X size={20} />
        </button>
        ...
        <div className="flex items-center gap-4 mb-10">
          ...
          <div>
            ...
            <p className="text-slate-muted text-xs font-bold uppercase tracking-widest mt-1">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="space-y-2">
            <label className="flex items-center gap-2 text-[10px] font-black text-slate-muted uppercase tracking-[0.2em] ml-2">
            ...
            <input 
              ...
              className="w-full bg-cool-gray/5 border border-white/10 rounded-2xl px-6 py-4 text-white placeholder:text-slate-muted focus:outline-none focus:border-indigo-500/50 transition-all shadow-inner"
          ...
          <div className="space-y-2">
            ...
            <textarea 
              ...
              className="w-full bg-cool-gray/5 border border-white/10 rounded-2xl px-6 py-4 text-white placeholder:text-slate-muted focus:outline-none focus:border-indigo-500/50 transition-all shadow-inner resize-none"
          ...
          <div className="space-y-2">
            ...
            {preview ? (
              <div className="relative w-full h-40 rounded-2xl overflow-hidden border border-white/10 bg-cool-gray/5">
              ...
              <label className="flex flex-col items-center justify-center w-full h-24 bg-cool-gray/5 border border-dashed border-white/20 hover:border-indigo-500/50 rounded-2xl cursor-pointer transition-all shadow-inner">
          ...
          <button 
            type="submit" 
            disabled={loading} 
            className="w-full bg-cool-gray text-slate-950 font-black py-5 rounded-3xl flex items-center justify-center gap-3 transition-all hover:bg-indigo-50 active:scale-95 shadow-xl shadow-white/5 mt-4 group"
          >
            {loading ? (
