...
const Login = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-sky-100 via-sky-50 to-blue-50 p-3 md:p-6 relative overflow-hidden">
      ...
      <div className="relative z-10 bg-white/95 backdrop-blur-xl border border-sky-200/80 p-6 md:p-10 rounded-[2.5rem] w-full max-w-md shadow-[0_28px_60px_rgba(15,23,42,0.12)]">
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <input 
                ...
                required
                className="w-full bg-slate-100 border border-slate-200 rounded-2xl py-3 md:py-4 pl-14 pr-4 text-sm md:text-base text-slate-900 focus:border-sky-400 outline-none transition-all shadow-sm"
        ...
        <p className="text-slate-500 text-center mt-6 md:mt-8 text-xs md:text-sm font-medium">
